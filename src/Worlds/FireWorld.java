...
public class FireWorld extends Worlds
{
    ...
    public void beginningStoryline(MainCharacter character)
    {
        ...
        Utilities.slowPrint(character.getFirstName() + ", you will be forced to solve fraction problems and division dilemmas by the entities born of fire chaos.", 50);
        System.out.println(); 
        ...
        System.out.println(); // newline
        Utilities.slowPrint("He is known for deceiving and exploiting his subject. He may give you a hard time. Try your best to acquire the fourth piece of the prism.", 50);
        System.out.println();
