    ...
    *******************/
    ...
    public void execute(MainCharacter character)
    {
        if (!character.getProgress()[1][1]) //Checks if the side quest has been completed already
        {
            ...
            "It presented its puzzling challenge: \"I am an odd number. If you take away one of the letters from my name, I become even.\"\n", 20);
            ...
            do
            {
                ...
                {
                    Utilities.slowPrint("The Earth Sentinel's stone features remained stern. \"Incorrect, you have 1 more chance,\" it intoned gravely.\n", 10);
                    chances--;

                }else if (answer != input && chances == 1)
                {
                    Utilities.slowPrint("You fall again and now must face the consequences by taking 2 damage.\n", 10);
                    chances--;
